...
const custom = L.tileLayer(serverSettings.custom_tilserver + '/tile/klokantech-basic/{z}/{x}/{y}/1/png', {maxZoom: 19, attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'})
