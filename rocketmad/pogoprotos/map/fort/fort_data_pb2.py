...
_FORTDATA_POKESTOPINCIDENTDISPLAY_INCIDENTDISPLAYTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INVASION_GRUNTB', index=4, number=4,
      serialized_options=None,
      type=None),
  ],
...
_FORTDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='is_ar_scan_eligible', full_name='pogoprotos.map.fort.FortData.is_ar_scan_eligible', index=32,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='geostore_tombstone_message_key', full_name='pogoprotos.map.fort.FortData.geostore_tombstone_message_key', index=33,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='geostore_suspension_message_key', full_name='pogoprotos.map.fort.FortData.geostore_suspension_message_key', index=34,
...
FortData = _reflection.GeneratedProtocolMessageType('FortData', (_message.Message,), dict(
  ...
  PokestopIncidentDisplay = _reflection.GeneratedProtocolMessageType('PokestopIncidentDisplay', (_message.Message,), dict(

    CharacterDisplay = _reflection.GeneratedProtocolMessageType('CharacterDisplay', (_message.Message,), dict(
    ...
    InvasionFinishedDisplay = _reflection.GeneratedProtocolMessageType('InvasionFinishedDisplay', (_message.Message,), dict(
