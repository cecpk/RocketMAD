...
_INVENTORYKEY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sticker_id', full_name='pogoprotos.inventory.InventoryKey.sticker_id', index=18,
