...
_NOTIFICATIONCATEGORY = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DEEP_LINKING', index=50, number=53,
      serialized_options=None,
      type=None),
  ],
