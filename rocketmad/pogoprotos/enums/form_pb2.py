...
_FORM = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SLOWPOKE_GALARIAN', index=2085, number=2582,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SLOWBRO_GALARIAN', index=2086, number=2583,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LAPRAS_COSTUME_2020', index=2087, number=2585,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GENGAR_COSTUME_2020', index=2088, number=2586,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SABLEYE_COSTUME_2020', index=2089, number=2668,
      serialized_options=None,
      type=None),
  ],
