...
# source: pogoprotos/enums/poi_image_type.proto
...
_POIIMAGETYPE = _descriptor.EnumDescriptor(
  name='PoiImageType',
  full_name='pogoprotos.enums.PoiImageType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_sym_db.RegisterEnumDescriptor(_POIIMAGETYPE)

PoiImageType = enum_type_wrapper.EnumTypeWrapper(_POIIMAGETYPE)
