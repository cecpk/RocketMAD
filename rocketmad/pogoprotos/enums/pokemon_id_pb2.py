...
_POKEMONID = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='OBSTAGOON', index=652, number=862,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PERRSERKER', index=653, number=863,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SIRFETCHD', index=654, number=865,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RUNERIGUS', index=655, number=867,
      serialized_options=None,
      type=None),
  ],
