...
_COSTUME = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='HALLOWEEN_2020', index=26, number=26,
      options=None,
      type=None),
  ],
