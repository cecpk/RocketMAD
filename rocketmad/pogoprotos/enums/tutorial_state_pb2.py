...
_TUTORIALSTATE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DAILY_BONUS_ENCOUNTER_TUTORIAL', index=41, number=45,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SPONSORED_GIFT_TUTORIAL', index=42, number=46,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='XGS_ONLINE_CONSENT_NOTE', index=43, number=47,
      serialized_options=None,
      type=None),
  ],
