...
_POKEMONMOVE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FLY', index=279, number=341,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='V_CREATE', index=280, number=342,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LEAF_STORM', index=281, number=343,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TRI_ATTACK', index=282, number=344,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GUST_FAST', index=283, number=345,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INCINERATE_FAST', index=284, number=346,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DARK_VOID', index=285, number=347,
      serialized_options=None,
      type=None),
  ],
