...
_VARIABLENAME = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RAID_INVITATION_DETAILS', index=50, number=1041,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LOOT_ITEMS', index=51, number=1042,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EVENT_ICON_URL', index=52, number=1043,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DL_ACTION', index=53, number=1100,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DL_CATEGORY', index=54, number=1101,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DL_TAB', index=55, number=1102,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DL_SKU', index=56, number=1103,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DL_ICON', index=57, number=1104,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DL_ID', index=58, number=1105,
      serialized_options=None,
      type=None),
  ],
