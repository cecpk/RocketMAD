...
_RAID = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='consumed_ticket', full_name='pogoprotos.data.raid.Raid.consumed_ticket', index=12,
