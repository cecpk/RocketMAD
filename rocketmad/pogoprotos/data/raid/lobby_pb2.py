...
_LOBBY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='invited_player_ids', full_name='pogoprotos.data.raid.Lobby.invited_player_ids', index=12,
