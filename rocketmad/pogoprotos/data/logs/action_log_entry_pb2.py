...
from pogoprotos.data.logs import buddy_consumables_log_entry_pb2 as pogoprotos_dot_data_dot_logs_dot_buddy__consumables__log__entry__pb2
...
_ACTIONLOGENTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='buddy_consumables', full_name='pogoprotos.data.logs.ActionLogEntry.buddy_consumables', index=23,
...
_ACTIONLOGENTRY.fields_by_name['buddy_consumables'].message_type = pogoprotos_dot_data_dot_logs_dot_buddy__consumables__log__entry__pb2._BUDDYCONSUMABLESLOGENTRY
...
_ACTIONLOGENTRY.oneofs_by_name['Action'].fields.append(
  _ACTIONLOGENTRY.fields_by_name['buddy_consumables'])
_ACTIONLOGENTRY.fields_by_name['buddy_consumables'].containing_oneof = _ACTIONLOGENTRY.oneofs_by_name['Action']
