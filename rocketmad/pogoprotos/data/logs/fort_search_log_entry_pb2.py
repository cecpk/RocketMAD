...
_FORTSEARCHLOGENTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='stickers', full_name='pogoprotos.data.logs.FortSearchLogEntry.stickers', index=10,
...
_FORTSEARCHLOGENTRY.fields_by_name['stickers'].message_type = pogoprotos_dot_inventory_dot_loot__item__pb2._LOOTITEM
