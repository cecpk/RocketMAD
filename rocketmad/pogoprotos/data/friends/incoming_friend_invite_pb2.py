...
_INCOMINGFRIENDINVITE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='niantic_social_graph_app_keys', full_name='pogoprotos.data.friends.IncomingFriendInvite.niantic_social_graph_app_keys', index=5,
...
_INCOMINGFRIENDINVITE.fields_by_name['niantic_social_graph_app_keys'].enum_type = pogoprotos_dot_data_dot_social_dot_social__pb2._SOCIAL_APPKEY
