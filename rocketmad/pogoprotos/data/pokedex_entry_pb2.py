...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n#pogoprotos/data/pokedex_entry.proto\x12\x0fpogoprotos.data\x1a\x1epogoprotos/enums/costume.proto\x1a\x1bpogoprotos/enums/form.proto\x1a\x1dpogoprotos/enums/gender.proto\x1a-pogoprotos/enums/temporary_evolution_id.proto\x1a!pogoprotos/enums/pokemon_id.proto\"\xb5\x07\n\x0cPokedexEntry\x12/\n\npokemon_id\x18\x01 \x01(\x0e\x32\x1b.pogoprotos.enums.PokemonId\x12\x19\n\x11times_encountered\x18\x02 \x01(\x05\x12\x16\n\x0etimes_captured\x18\x03 \x01(\x05\x12\x1e\n\x16\x65volution_stone_pieces\x18\x04 \x01(\x05\x12\x18\n\x10\x65volution_stones\x18\x05 \x01(\x05\x12\x34\n\x11\x63\x61ptured_costumes\x18\x06 \x03(\x0e\x32\x19.pogoprotos.enums.Costume\x12.\n\x0e\x63\x61ptured_forms\x18\x07 \x03(\x0e\x32\x16.pogoprotos.enums.Form\x12\x32\n\x10\x63\x61ptured_genders\x18\x08 \x03(\x0e\x32\x18.pogoprotos.enums.Gender\x12\x16\n\x0e\x63\x61ptured_shiny\x18\t \x01(\x08\x12\x37\n\x14\x65ncountered_costumes\x18\n \x03(\x0e\x32\x19.pogoprotos.enums.Costume\x12\x31\n\x11\x65ncountered_forms\x18\x0b \x03(\x0e\x32\x16.pogoprotos.enums.Form\x12\x35\n\x13\x65ncountered_genders\x18\x0c \x03(\x0e\x32\x18.pogoprotos.enums.Gender\x12\x19\n\x11\x65ncountered_shiny\x18\r \x01(\x08\x12\x1c\n\x14times_lucky_received\x18\x0e \x01(\x05\x12\x16\n\x0etimes_purified\x18\x0f \x01(\x05\x12@\n\rtemp_evo_data\x18\x10 \x03(\x0b\x32).pogoprotos.data.PokedexEntry.TempEvoData\x12\x34\n\x14\x63\x61ptured_shiny_forms\x18\x11 \x03(\x0e\x32\x16.pogoprotos.enums.Form\x1a\xe8\x01\n\x0bTempEvoData\x12;\n\x0btemp_evo_id\x18\x01 \x01(\x0e\x32&.pogoprotos.enums.TemporaryEvolutionId\x12\x19\n\x11times_encountered\x18\x02 \x01(\x05\x12\x16\n\x0etimes_obtained\x18\x03 \x01(\x05\x12\x35\n\x13genders_encountered\x18\x04 \x03(\x0e\x32\x18.pogoprotos.enums.Gender\x12\x32\n\x10genders_obtained\x18\x05 \x03(\x0e\x32\x18.pogoprotos.enums.Genderb\x06proto3')
  ,
  dependencies=[pogoprotos_dot_enums_dot_costume__pb2.DESCRIPTOR,pogoprotos_dot_enums_dot_form__pb2.DESCRIPTOR,pogoprotos_dot_enums_dot_gender__pb2.DESCRIPTOR,pogoprotos_dot_enums_dot_temporary__evolution__id__pb2.DESCRIPTOR,pogoprotos_dot_enums_dot_pokemon__id__pb2.DESCRIPTOR,])




_POKEDEXENTRY_TEMPEVODATA = _descriptor.Descriptor(
  name='TempEvoData',
  full_name='pogoprotos.data.PokedexEntry.TempEvoData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='temp_evo_id', full_name='pogoprotos.data.PokedexEntry.TempEvoData.temp_evo_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='times_encountered', full_name='pogoprotos.data.PokedexEntry.TempEvoData.times_encountered', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='times_obtained', full_name='pogoprotos.data.PokedexEntry.TempEvoData.times_obtained', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='genders_encountered', full_name='pogoprotos.data.PokedexEntry.TempEvoData.genders_encountered', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='genders_obtained', full_name='pogoprotos.data.PokedexEntry.TempEvoData.genders_obtained', index=4,
...
_POKEDEXENTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='times_purified', full_name='pogoprotos.data.PokedexEntry.times_purified', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='temp_evo_data', full_name='pogoprotos.data.PokedexEntry.temp_evo_data', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='captured_shiny_forms', full_name='pogoprotos.data.PokedexEntry.captured_shiny_forms', index=16,
  ...
  nested_types=[_POKEDEXENTRY_TEMPEVODATA, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_POKEDEXENTRY_TEMPEVODATA.fields_by_name['temp_evo_id'].enum_type = pogoprotos_dot_enums_dot_temporary__evolution__id__pb2._TEMPORARYEVOLUTIONID
_POKEDEXENTRY_TEMPEVODATA.fields_by_name['genders_encountered'].enum_type = pogoprotos_dot_enums_dot_gender__pb2._GENDER
_POKEDEXENTRY_TEMPEVODATA.fields_by_name['genders_obtained'].enum_type = pogoprotos_dot_enums_dot_gender__pb2._GENDER
_POKEDEXENTRY_TEMPEVODATA.containing_type = _POKEDEXENTRY
...
_POKEDEXENTRY.fields_by_name['temp_evo_data'].message_type = _POKEDEXENTRY_TEMPEVODATA
_POKEDEXENTRY.fields_by_name['captured_shiny_forms'].enum_type = pogoprotos_dot_enums_dot_form__pb2._FORM
...
PokedexEntry = _reflection.GeneratedProtocolMessageType('PokedexEntry', (_message.Message,), dict(
  ...
  TempEvoData = _reflection.GeneratedProtocolMessageType('TempEvoData', (_message.Message,), dict(
    DESCRIPTOR = _POKEDEXENTRY_TEMPEVODATA,
...
_sym_db.RegisterMessage(PokedexEntry.TempEvoData)
