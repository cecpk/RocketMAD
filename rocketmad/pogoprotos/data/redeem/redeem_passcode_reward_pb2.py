...
from pogoprotos.data.sticker import redeemed_sticker_pb2 as pogoprotos_dot_data_dot_sticker_dot_redeemed__sticker__pb2
...
_REDEEMPASSCODEREWARD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='redeemed_stickers', full_name='pogoprotos.data.redeem.RedeemPasscodeReward.redeemed_stickers', index=8,
...
_REDEEMPASSCODEREWARD.fields_by_name['redeemed_stickers'].message_type = pogoprotos_dot_data_dot_sticker_dot_redeemed__sticker__pb2._REDEEMEDSTICKER
