...
_SHOPPINGPAGECLICKTELEMETRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ml_bundle_tracking_id', full_name='pogoprotos.data.telemetry.ShoppingPageClickTelemetry.ml_bundle_tracking_id', index=4,
...
ShoppingPageClickTelemetry = _reflection.GeneratedProtocolMessageType('ShoppingPageClickTelemetry', (_message.Message,), dict(
