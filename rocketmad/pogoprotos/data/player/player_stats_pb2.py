...
_PLAYERSTATS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_pokemon_purified', full_name='pogoprotos.data.player.PlayerStats.num_pokemon_purified', index=42,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_grunts_defeated', full_name='pogoprotos.data.player.PlayerStats.num_grunts_defeated', index=43,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_best_buddies', full_name='pogoprotos.data.player.PlayerStats.num_best_buddies', index=44,
