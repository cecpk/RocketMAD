...
from pogoprotos.data.player import timed_group_challenge_player_stats_pb2 as pogoprotos_dot_data_dot_player_dot_timed__group__challenge__player__stats__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n2pogoprotos/data/player/player_public_profile.proto\x12\x16pogoprotos.data.player\x1a*pogoprotos/data/player/player_avatar.proto\x1a)pogoprotos/data/player/player_badge.proto\x1a?pogoprotos/data/player/timed_group_challenge_player_stats.proto\x1a!pogoprotos/enums/team_color.proto\x1a%pogoprotos/enums/gym_badge_type.proto\"\xff\x03\n\x13PlayerPublicProfile\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\r\n\x05level\x18\x02 \x01(\x05\x12\x34\n\x06\x61vatar\x18\x03 \x01(\x0b\x32$.pogoprotos.data.player.PlayerAvatar\x12/\n\nteam_color\x18\x04 \x01(\x0e\x32\x1b.pogoprotos.enums.TeamColor\x12\x13\n\x0b\x62\x61ttles_won\x18\x05 \x01(\x05\x12\x11\n\tkm_walked\x18\x06 \x01(\x02\x12\x16\n\x0e\x63\x61ught_pokemon\x18\x07 \x01(\x05\x12\x36\n\x0egym_badge_type\x18\x08 \x01(\x0e\x32\x1e.pogoprotos.enums.GymBadgeType\x12\x33\n\x06\x62\x61\x64ges\x18\t \x03(\x0b\x32#.pogoprotos.data.player.PlayerBadge\x12\x12\n\nexperience\x18\n \x01(\x03\x12\x1a\n\x12has_shared_ex_pass\x18\x0b \x01(\x08\x12\x13\n\x0b\x63ombat_rank\x18\x0c \x01(\x05\x12\x15\n\rcombat_rating\x18\r \x01(\x02\x12[\n\x1btimed_group_challenge_stats\x18\x0e \x01(\x0b\x32\x36.pogoprotos.data.player.TimedGroupChallengePlayerStatsb\x06proto3')
  ,
  dependencies=[pogoprotos_dot_data_dot_player_dot_player__avatar__pb2.DESCRIPTOR,pogoprotos_dot_data_dot_player_dot_player__badge__pb2.DESCRIPTOR,pogoprotos_dot_data_dot_player_dot_timed__group__challenge__player__stats__pb2.DESCRIPTOR,pogoprotos_dot_enums_dot_team__color__pb2.DESCRIPTOR,pogoprotos_dot_enums_dot_gym__badge__type__pb2.DESCRIPTOR,])
...
_PLAYERPUBLICPROFILE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='timed_group_challenge_stats', full_name='pogoprotos.data.player.PlayerPublicProfile.timed_group_challenge_stats', index=13,
...
_PLAYERPUBLICPROFILE.fields_by_name['timed_group_challenge_stats'].message_type = pogoprotos_dot_data_dot_player_dot_timed__group__challenge__player__stats__pb2._TIMEDGROUPCHALLENGEPLAYERSTATS
