...
_BUDDYHISTORYDATA_SOUVENIRSCOLLECTEDENTRY.has_options = True
_BUDDYHISTORYDATA_SOUVENIRSCOLLECTEDENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
