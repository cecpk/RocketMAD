...
_PLAYERDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='player_preferences', full_name='pogoprotos.data.PlayerData.player_preferences', index=25,
...
_PLAYERDATA.fields_by_name['player_preferences'].message_type = pogoprotos_dot_data_dot_player_dot_player__preferences__pb2._PLAYERPREFERENCES
