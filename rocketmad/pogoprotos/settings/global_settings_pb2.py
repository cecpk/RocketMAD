...
_GLOBALSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='lobby_client_settings', full_name='pogoprotos.settings.GlobalSettings.lobby_client_settings', index=54,
