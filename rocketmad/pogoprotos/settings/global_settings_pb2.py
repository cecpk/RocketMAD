...
from pogoprotos.settings import daily_encounter_global_settings_pb2 as pogoprotos_dot_settings_dot_daily__encounter__global__settings__pb2
from pogoprotos.settings import raid_ticket_settings_pb2 as pogoprotos_dot_settings_dot_raid__ticket__settings__pb2
from pogoprotos.settings import rocket_balloon_global_settings_pb2 as pogoprotos_dot_settings_dot_rocket__balloon__global__settings__pb2
from pogoprotos.settings import lobby_client_settings_pb2 as pogoprotos_dot_settings_dot_lobby__client__settings__pb2
from pogoprotos.settings import timed_group_challenge_settings_pb2 as pogoprotos_dot_settings_dot_timed__group__challenge__settings__pb2
from pogoprotos.settings import mega_evo_global_settings_pb2 as pogoprotos_dot_settings_dot_mega__evo__global__settings__pb2
from pogoprotos.settings import quest_evolution_global_settings_pb2 as pogoprotos_dot_settings_dot_quest__evolution__global__settings__pb2
from pogoprotos.settings import sponsored_poi_feedback_settings_pb2 as pogoprotos_dot_settings_dot_sponsored__poi__feedback__settings__pb2
from pogoprotos.settings import crashlytics_settings_pb2 as pogoprotos_dot_settings_dot_crashlytics__settings__pb2
from pogoprotos.settings import catch_pokemon_global_settings_pb2 as pogoprotos_dot_settings_dot_catch__pokemon__global__settings__pb2
from pogoprotos.settings import idfa_settings_pb2 as pogoprotos_dot_settings_dot_idfa__settings__pb2
...
_GLOBALSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='daily_encounter_settings', full_name='pogoprotos.settings.GlobalSettings.daily_encounter_settings', index=50,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='raid_ticket_settings', full_name='pogoprotos.settings.GlobalSettings.raid_ticket_settings', index=51,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rocket_balloon_settings', full_name='pogoprotos.settings.GlobalSettings.rocket_balloon_settings', index=52,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timed_group_challenge_settings', full_name='pogoprotos.settings.GlobalSettings.timed_group_challenge_settings', index=53,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mega_evo_settings', full_name='pogoprotos.settings.GlobalSettings.mega_evo_settings', index=54,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='lobby_client_settings', full_name='pogoprotos.settings.GlobalSettings.lobby_client_settings', index=55,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='quest_evolution_settings', full_name='pogoprotos.settings.GlobalSettings.quest_evolution_settings', index=56,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sponsored_poi_feedback_settings', full_name='pogoprotos.settings.GlobalSettings.sponsored_poi_feedback_settings', index=57,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='crashlytics_settings', full_name='pogoprotos.settings.GlobalSettings.crashlytics_settings', index=58,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='catch_pokemon_settings', full_name='pogoprotos.settings.GlobalSettings.catch_pokemon_settings', index=59,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='idfa_settings', full_name='pogoprotos.settings.GlobalSettings.idfa_settings', index=60,
...
_GLOBALSETTINGS.fields_by_name['daily_encounter_settings'].message_type = pogoprotos_dot_settings_dot_daily__encounter__global__settings__pb2._DAILYENCOUNTERGLOBALSETTINGS
_GLOBALSETTINGS.fields_by_name['raid_ticket_settings'].message_type = pogoprotos_dot_settings_dot_raid__ticket__settings__pb2._RAIDTICKETSETTINGS
_GLOBALSETTINGS.fields_by_name['rocket_balloon_settings'].message_type = pogoprotos_dot_settings_dot_rocket__balloon__global__settings__pb2._ROCKETBALLOONGLOBALSETTINGS
_GLOBALSETTINGS.fields_by_name['timed_group_challenge_settings'].message_type = pogoprotos_dot_settings_dot_timed__group__challenge__settings__pb2._TIMEDGROUPCHALLENGESETTINGS
_GLOBALSETTINGS.fields_by_name['mega_evo_settings'].message_type = pogoprotos_dot_settings_dot_mega__evo__global__settings__pb2._MEGAEVOGLOBALSETTINGS
_GLOBALSETTINGS.fields_by_name['lobby_client_settings'].message_type = pogoprotos_dot_settings_dot_lobby__client__settings__pb2._LOBBYCLIENTSETTINGS
_GLOBALSETTINGS.fields_by_name['quest_evolution_settings'].message_type = pogoprotos_dot_settings_dot_quest__evolution__global__settings__pb2._QUESTEVOLUTIONGLOBALSETTINGS
_GLOBALSETTINGS.fields_by_name['sponsored_poi_feedback_settings'].message_type = pogoprotos_dot_settings_dot_sponsored__poi__feedback__settings__pb2._SPONSOREDPOIFEEDBACKSETTINGS
_GLOBALSETTINGS.fields_by_name['crashlytics_settings'].message_type = pogoprotos_dot_settings_dot_crashlytics__settings__pb2._CRASHLYTICSSETTINGS
_GLOBALSETTINGS.fields_by_name['catch_pokemon_settings'].message_type = pogoprotos_dot_settings_dot_catch__pokemon__global__settings__pb2._CATCHPOKEMONGLOBALSETTINGS
_GLOBALSETTINGS.fields_by_name['idfa_settings'].message_type = pogoprotos_dot_settings_dot_idfa__settings__pb2._IDFASETTINGS
