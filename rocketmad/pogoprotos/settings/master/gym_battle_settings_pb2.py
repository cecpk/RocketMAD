...
_GYMBATTLESETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='shadow_pokemon_attack_bonus_multiplier', full_name='pogoprotos.settings.master.GymBattleSettings.shadow_pokemon_attack_bonus_multiplier', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='shadow_pokemon_defense_bonus_multiplier', full_name='pogoprotos.settings.master.GymBattleSettings.shadow_pokemon_defense_bonus_multiplier', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='purified_pokemon_attack_multiplier_vs_shadow', full_name='pogoprotos.settings.master.GymBattleSettings.purified_pokemon_attack_multiplier_vs_shadow', index=18,
