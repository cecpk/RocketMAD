...
from pogoprotos.settings.master.item import incident_ticket_attributes_pb2 as pogoprotos_dot_settings_dot_master_dot_item_dot_incident__ticket__attributes__pb2
from pogoprotos.settings.master.item import global_event_ticket_attributes_pb2 as pogoprotos_dot_settings_dot_master_dot_item_dot_global__event__ticket__attributes__pb2
...
_ITEMSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='incident_ticket', full_name='pogoprotos.settings.master.ItemSettings.incident_ticket', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='global_event_ticket', full_name='pogoprotos.settings.master.ItemSettings.global_event_ticket', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ignore_inventory_space', full_name='pogoprotos.settings.master.ItemSettings.ignore_inventory_space', index=18,
...
_ITEMSETTINGS.fields_by_name['incident_ticket'].message_type = pogoprotos_dot_settings_dot_master_dot_item_dot_incident__ticket__attributes__pb2._INCIDENTTICKETATTRIBUTES
_ITEMSETTINGS.fields_by_name['global_event_ticket'].message_type = pogoprotos_dot_settings_dot_master_dot_item_dot_global__event__ticket__attributes__pb2._GLOBALEVENTTICKETATTRIBUTES
