...
_USERATTRIBUTES = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='balloon_battles_completed', full_name='pogoprotos.settings.master.item.UserAttributes.balloon_battles_completed', index=54,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='balloon_battles_won', full_name='pogoprotos.settings.master.item.UserAttributes.balloon_battles_won', index=55,
