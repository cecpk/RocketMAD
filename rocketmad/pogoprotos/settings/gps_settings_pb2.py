...
_GPSSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='idle_threshold_speed_meters_per_second', full_name='pogoprotos.settings.GpsSettings.idle_threshold_speed_meters_per_second', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='idle_threshold_duration_seconds', full_name='pogoprotos.settings.GpsSettings.idle_threshold_duration_seconds', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='idle_sample_interval_seconds', full_name='pogoprotos.settings.GpsSettings.idle_sample_interval_seconds', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='idle_speed_sample_count', full_name='pogoprotos.settings.GpsSettings.idle_speed_sample_count', index=7,
