...
_COMBATGLOBALSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='latency_compensation_threshold_ms', full_name='pogoprotos.settings.CombatGlobalSettings.latency_compensation_threshold_ms', index=23,
