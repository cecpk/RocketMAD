...
# source: pogoprotos/networking/requests/game/gameaccountregistry/game_account_registry_actions.proto
...
_GAMEACCOUNTREGISTRYACTIONS = _descriptor.EnumDescriptor(
  ...
  full_name='pogoprotos.networking.requests.game.gameaccountregistry.GameAccountRegistryActions',
  filename=None,
  file=DESCRIPTOR,
  values=[
