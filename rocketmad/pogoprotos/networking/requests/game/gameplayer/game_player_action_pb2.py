...
# source: pogoprotos/networking/requests/game/gameplayer/game_player_action.proto
...
_GAMEPLAYERACTION = _descriptor.EnumDescriptor(
  ...
  full_name='pogoprotos.networking.requests.game.gameplayer.GamePlayerAction',
  filename=None,
  file=DESCRIPTOR,
  values=[
