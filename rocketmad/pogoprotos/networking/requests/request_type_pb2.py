...
_REQUESTTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_ROCKET_BALLOON', index=161, number=1206,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='START_ROCKET_BALLOON_INCIDENT', index=162, number=1207,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='VS_SEEKER_START_MATCHMAKING', index=163, number=1300,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CANCEL_MATCHMAKING', index=164, number=1301,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_MATCHMAKING_STATUS', index=165, number=1302,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='COMPLETE_VS_SEEKER_AND_RESTART_CHARGING', index=166, number=1303,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_VS_SEEKER_STATUS', index=167, number=1304,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='COMPLETE_COMBAT_COMPETITIVE_SEASON_ACTION', index=168, number=1305,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CLAIM_VS_SEEKER_REWARDS', index=169, number=1306,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='VS_SEEKER_REWARD_ENCOUNTER', index=170, number=1307,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ACTIVATE_VS_SEEKER', index=171, number=1308,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_BUDDY_MAP', index=172, number=1350,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_BUDDY_STATS', index=173, number=1351,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FEED_BUDDY', index=174, number=1352,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='OPEN_BUDDY_GIFT', index=175, number=1353,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PET_BUDDY', index=176, number=1354,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_BUDDY_HISTORY', index=177, number=1355,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CREATE_BUDDY_MUTLIPLAYER_SESSION', index=178, number=1456,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='JOIN_BUDDY_MULTIPLAYER_SESSION', index=179, number=1457,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LEAVE_BUDDY_MULTIPLAYER_SESSION', index=180, number=1458,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_TODAY_VIEW', index=181, number=1501,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='REMOTE_GIFT_PING', index=182, number=1503,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SEND_RAID_INVITATION', index=183, number=1504,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_DAILY_ENCOUNTER', index=184, number=1601,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DAILY_ENCOUNTER', index=185, number=1602,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='OPEN_SPONSORED_GIFT', index=186, number=1650,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SPONSORED_GIFT_REPORT_INTERACTION', index=187, number=1651,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SAVE_PLAYER_PREFERENCES', index=188, number=1652,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_TIMED_GROUP_CHALLENGE', index=189, number=1700,
      serialized_options=None,
      type=None),
  ],
