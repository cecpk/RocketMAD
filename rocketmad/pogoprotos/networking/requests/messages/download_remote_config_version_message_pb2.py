...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\nTpogoprotos/networking/requests/messages/download_remote_config_version_message.proto\x12\'pogoprotos.networking.requests.messages\x1a\x1fpogoprotos/enums/platform.proto\x1a\x1cpogoprotos/enums/store.proto\"\xe3\x01\n\"DownloadRemoteConfigVersionMessage\x12,\n\x08platform\x18\x01 \x01(\x0e\x32\x1a.pogoprotos.enums.Platform\x12\x1b\n\x13\x64\x65vice_manufacturer\x18\x02 \x01(\t\x12\x14\n\x0c\x64\x65vice_model\x18\x03 \x01(\t\x12\x0e\n\x06locale\x18\x04 \x01(\t\x12\x13\n\x0b\x61pp_version\x18\x05 \x01(\r\x12&\n\x05store\x18\x06 \x01(\x0e\x32\x17.pogoprotos.enums.Store\x12\x0f\n\x07\x63\x61rrier\x18\x07 \x01(\tb\x06proto3')
  ,
...
_DOWNLOADREMOTECONFIGVERSIONMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='carrier', full_name='pogoprotos.networking.requests.messages.DownloadRemoteConfigVersionMessage.carrier', index=6,
