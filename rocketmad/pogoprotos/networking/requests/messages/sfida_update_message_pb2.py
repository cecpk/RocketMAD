...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\nBpogoprotos/networking/requests/messages/sfida_update_message.proto\x12\'pogoprotos.networking.requests.messages\"<\n\x12SfidaUpdateMessage\x12\x12\n\nplayer_lat\x18\x01 \x01(\x01\x12\x12\n\nplayer_lng\x18\x02 \x01(\x01\x62\x06proto3')
)
