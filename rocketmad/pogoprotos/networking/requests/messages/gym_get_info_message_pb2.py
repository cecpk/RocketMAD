...
_GYMGETINFOMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='inviter_id', full_name='pogoprotos.networking.requests.messages.GymGetInfoMessage.inviter_id', index=5,
