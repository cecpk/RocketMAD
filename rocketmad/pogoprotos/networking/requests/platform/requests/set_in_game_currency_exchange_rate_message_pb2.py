...
# source: pogoprotos/networking/requests/platform/requests/set_in_game_currency_exchange_rate_message.proto
...
_SETINGAMECURRENCYEXCHANGERATEMESSAGE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.requests.platform.requests.SetInGameCurrencyExchangeRateMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='in_game_currency', full_name='pogoprotos.networking.requests.platform.requests.SetInGameCurrencyExchangeRateMessage.in_game_currency', index=0,
...
SetInGameCurrencyExchangeRateMessage = _reflection.GeneratedProtocolMessageType('SetInGameCurrencyExchangeRateMessage', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.requests.platform.requests.set_in_game_currency_exchange_rate_message_pb2'
