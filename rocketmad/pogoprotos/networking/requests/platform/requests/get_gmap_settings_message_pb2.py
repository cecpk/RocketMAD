...
# source: pogoprotos/networking/requests/platform/requests/get_gmap_settings_message.proto
...
_GETGMAPSETTINGSMESSAGE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.requests.platform.requests.GetGmapSettingsMessage',
  filename=None,
  file=DESCRIPTOR,
...
GetGmapSettingsMessage = _reflection.GeneratedProtocolMessageType('GetGmapSettingsMessage', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.requests.platform.requests.get_gmap_settings_message_pb2'
