...
# source: pogoprotos/networking/requests/platform/requests/add_login_action_message.proto
...
_ADDLOGINACTIONMESSAGE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.requests.platform.requests.AddLoginActionMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='identity_provider', full_name='pogoprotos.networking.requests.platform.requests.AddLoginActionMessage.identity_provider', index=0,
...
AddLoginActionMessage = _reflection.GeneratedProtocolMessageType('AddLoginActionMessage', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.requests.platform.requests.add_login_action_message_pb2'
