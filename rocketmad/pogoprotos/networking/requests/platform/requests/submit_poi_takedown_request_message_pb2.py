...
# source: pogoprotos/networking/requests/platform/requests/submit_poi_takedown_request_message.proto
...
_SUBMITPOITAKEDOWNREQUESTMESSAGE_POIINVALIDREASON = _descriptor.EnumDescriptor(
  ...
  full_name='pogoprotos.networking.requests.platform.requests.SubmitPoiTakedownRequestMessage.PoiInvalidReason',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_SUBMITPOITAKEDOWNREQUESTMESSAGE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.requests.platform.requests.SubmitPoiTakedownRequestMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='poi_id', full_name='pogoprotos.networking.requests.platform.requests.SubmitPoiTakedownRequestMessage.poi_id', index=0,
...
SubmitPoiTakedownRequestMessage = _reflection.GeneratedProtocolMessageType('SubmitPoiTakedownRequestMessage', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.requests.platform.requests.submit_poi_takedown_request_message_pb2'
