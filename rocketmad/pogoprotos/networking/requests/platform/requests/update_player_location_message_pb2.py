...
# source: pogoprotos/networking/requests/platform/requests/update_player_location_message.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/requests/platform/requests/update_player_location_message.proto',
  package='pogoprotos.networking.requests.platform.requests',
  syntax='proto3',
  serialized_pb=_b('\nUpogoprotos/networking/requests/platform/requests/update_player_location_message.proto\x12\x30pogoprotos.networking.requests.platform.requests\"\xaa\x02\n\x1bUpdatePlayerLocationMessage\x12\x1b\n\x13geofence_identifier\x18\x01 \x01(\t\x12h\n\x06reason\x18\x02 \x01(\x0e\x32X.pogoprotos.networking.requests.platform.requests.UpdatePlayerLocationMessage.PingReason\"\x83\x01\n\nPingReason\x12\t\n\x05UNSET\x10\x00\x12\x12\n\x0e\x45NTRANCE_EVENT\x10\x01\x12\x0e\n\nEXIT_EVENT\x10\x02\x12\x0f\n\x0b\x44WELL_EVENT\x10\x03\x12\x0f\n\x0bVISIT_EVENT\x10\x04\x12\x12\n\x0e\x46ITNESS_WAKEUP\x10\x05\x12\x10\n\x0cOTHER_WAKEUP\x10\x06\x62\x06proto3')
)
...
_UPDATEPLAYERLOCATIONMESSAGE_PINGREASON = _descriptor.EnumDescriptor(
  name='PingReason',
  full_name='pogoprotos.networking.requests.platform.requests.UpdatePlayerLocationMessage.PingReason',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_UPDATEPLAYERLOCATIONMESSAGE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.requests.platform.requests.UpdatePlayerLocationMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='geofence_identifier', full_name='pogoprotos.networking.requests.platform.requests.UpdatePlayerLocationMessage.geofence_identifier', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='reason', full_name='pogoprotos.networking.requests.platform.requests.UpdatePlayerLocationMessage.reason', index=1,
...
UpdatePlayerLocationMessage = _reflection.GeneratedProtocolMessageType('UpdatePlayerLocationMessage', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.requests.platform.requests.update_player_location_message_pb2'
