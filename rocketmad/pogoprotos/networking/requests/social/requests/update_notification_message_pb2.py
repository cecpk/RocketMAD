...
# source: pogoprotos/networking/requests/social/requests/update_notification_message.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/requests/social/requests/update_notification_message.proto',
  package='pogoprotos.networking.requests.social.requests',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nPpogoprotos/networking/requests/social/requests/update_notification_message.proto\x12.pogoprotos.networking.requests.social.requests\x1a)pogoprotos/enums/notification_state.proto\"\x86\x01\n\x19UpdateNotificationMessage\x12\x18\n\x10notification_ids\x18\x01 \x03(\t\x12\x1b\n\x13\x63reate_timestamp_ms\x18\x02 \x03(\x03\x12\x32\n\x05state\x18\x03 \x01(\x0e\x32#.pogoprotos.enums.NotificationStateb\x06proto3')
  ,
...
_UPDATENOTIFICATIONMESSAGE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.requests.social.requests.UpdateNotificationMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='notification_ids', full_name='pogoprotos.networking.requests.social.requests.UpdateNotificationMessage.notification_ids', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='create_timestamp_ms', full_name='pogoprotos.networking.requests.social.requests.UpdateNotificationMessage.create_timestamp_ms', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='state', full_name='pogoprotos.networking.requests.social.requests.UpdateNotificationMessage.state', index=2,
...
UpdateNotificationMessage = _reflection.GeneratedProtocolMessageType('UpdateNotificationMessage', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.requests.social.requests.update_notification_message_pb2'
