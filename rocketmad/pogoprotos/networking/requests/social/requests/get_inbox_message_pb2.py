...
# source: pogoprotos/networking/requests/social/requests/get_inbox_message.proto
...
_GETINBOXMESSAGE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.requests.social.requests.GetInboxMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='is_history', full_name='pogoprotos.networking.requests.social.requests.GetInboxMessage.is_history', index=0,
...
GetInboxMessage = _reflection.GeneratedProtocolMessageType('GetInboxMessage', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.requests.social.requests.get_inbox_message_pb2'
