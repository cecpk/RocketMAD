...
# source: pogoprotos/networking/responses/titan/responses/get_gmap_settings_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/responses/titan/responses/get_gmap_settings_response.proto',
  package='pogoprotos.networking.responses.titan.responses',
  syntax='proto3',
  serialized_pb=_b('\nPpogoprotos/networking/responses/titan/responses/get_gmap_settings_response.proto\x12/pogoprotos.networking.responses.titan.responses\"\xa0\x02\n\x17GetGmapSettingsResponse\x12_\n\x06result\x18\x01 \x01(\x0e\x32O.pogoprotos.networking.responses.titan.responses.GetGmapSettingsResponse.Result\x12\x19\n\x11gmap_template_url\x18\x02 \x01(\t\x12\"\n\x1amax_poi_distance_in_meters\x18\x03 \x01(\x05\"e\n\x06Result\x12\t\n\x05UNSET\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x11\n\rERROR_UNKNOWN\x10\x02\x12\x18\n\x14\x45RROR_MISSING_CONFIG\x10\x03\x12\x16\n\x12\x45RROR_NO_UNIQUE_ID\x10\x04\x62\x06proto3')
)
...
_GETGMAPSETTINGSRESPONSE_RESULT = _descriptor.EnumDescriptor(
  name='Result',
  full_name='pogoprotos.networking.responses.titan.responses.GetGmapSettingsResponse.Result',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_GETGMAPSETTINGSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.titan.responses.GetGmapSettingsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='pogoprotos.networking.responses.titan.responses.GetGmapSettingsResponse.result', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gmap_template_url', full_name='pogoprotos.networking.responses.titan.responses.GetGmapSettingsResponse.gmap_template_url', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_poi_distance_in_meters', full_name='pogoprotos.networking.responses.titan.responses.GetGmapSettingsResponse.max_poi_distance_in_meters', index=2,
...
GetGmapSettingsResponse = _reflection.GeneratedProtocolMessageType('GetGmapSettingsResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.responses.titan.responses.get_gmap_settings_response_pb2'
