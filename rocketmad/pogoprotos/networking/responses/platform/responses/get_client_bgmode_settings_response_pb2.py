...
# source: pogoprotos/networking/responses/platform/responses/get_client_bgmode_settings_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/responses/platform/responses/get_client_bgmode_settings_response.proto',
  package='pogoprotos.networking.responses.platform.responses',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n\\pogoprotos/networking/responses/platform/responses/get_client_bgmode_settings_response.proto\x12\x32pogoprotos.networking.responses.platform.responses\x1a\x39pogoprotos/settings/background_mode_client_settings.proto\"\x87\x02\n\x1fGetClientBgmodeSettingsResponse\x12j\n\x06status\x18\x01 \x01(\x0e\x32Z.pogoprotos.networking.responses.platform.responses.GetClientBgmodeSettingsResponse.Status\x12\x43\n\x08settings\x18\x02 \x01(\x0b\x32\x31.pogoprotos.settings.BackgroundModeClientSettings\"3\n\x06Status\x12\t\n\x05UNSET\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x11\n\rERROR_UNKNOWN\x10\x02\x62\x06proto3')
  ,
...
_GETCLIENTBGMODESETTINGSRESPONSE_STATUS = _descriptor.EnumDescriptor(
  name='Status',
  full_name='pogoprotos.networking.responses.platform.responses.GetClientBgmodeSettingsResponse.Status',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_GETCLIENTBGMODESETTINGSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.platform.responses.GetClientBgmodeSettingsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='pogoprotos.networking.responses.platform.responses.GetClientBgmodeSettingsResponse.status', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='settings', full_name='pogoprotos.networking.responses.platform.responses.GetClientBgmodeSettingsResponse.settings', index=1,
...
GetClientBgmodeSettingsResponse = _reflection.GeneratedProtocolMessageType('GetClientBgmodeSettingsResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.responses.platform.responses.get_client_bgmode_settings_response_pb2'
