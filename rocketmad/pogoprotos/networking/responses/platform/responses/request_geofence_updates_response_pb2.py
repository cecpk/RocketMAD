...
# source: pogoprotos/networking/responses/platform/responses/request_geofence_updates_response.proto
...
_REQUESTGEOFENCEUPDATESRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.platform.responses.RequestGeofenceUpdatesResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='geofence', full_name='pogoprotos.networking.responses.platform.responses.RequestGeofenceUpdatesResponse.geofence', index=0,
...
RequestGeofenceUpdatesResponse = _reflection.GeneratedProtocolMessageType('RequestGeofenceUpdatesResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.responses.platform.responses.request_geofence_updates_response_pb2'
