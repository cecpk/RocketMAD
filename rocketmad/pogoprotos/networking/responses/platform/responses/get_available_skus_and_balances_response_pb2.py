...
# source: pogoprotos/networking/responses/platform/responses/get_available_skus_and_balances_response.proto
...
_GETAVAILABLESKUSANDBALANCESRESPONSE_STATUS = _descriptor.EnumDescriptor(
  name='Status',
  full_name='pogoprotos.networking.responses.platform.responses.GetAvailableSkusAndBalancesResponse.Status',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_GETAVAILABLESKUSANDBALANCESRESPONSE_AVAILABLESKU = _descriptor.Descriptor(
  name='AvailableSku',
  full_name='pogoprotos.networking.responses.platform.responses.GetAvailableSkusAndBalancesResponse.AvailableSku',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='pogoprotos.networking.responses.platform.responses.GetAvailableSkusAndBalancesResponse.AvailableSku.id', index=0,
...
_GETAVAILABLESKUSANDBALANCESRESPONSE_GAMEITEMCONTENT = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.platform.responses.GetAvailableSkusAndBalancesResponse.GameItemContent',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='pogoprotos.networking.responses.platform.responses.GetAvailableSkusAndBalancesResponse.GameItemContent.type', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETAVAILABLESKUSANDBALANCESRESPONSE_SKUPRESENTATION = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.platform.responses.GetAvailableSkusAndBalancesResponse.SkuPresentation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='pogoprotos.networking.responses.platform.responses.GetAvailableSkusAndBalancesResponse.SkuPresentation.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETAVAILABLESKUSANDBALANCESRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.platform.responses.GetAvailableSkusAndBalancesResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='pogoprotos.networking.responses.platform.responses.GetAvailableSkusAndBalancesResponse.status', index=0,
...
GetAvailableSkusAndBalancesResponse = _reflection.GeneratedProtocolMessageType('GetAvailableSkusAndBalancesResponse', (_message.Message,), dict(
  ...
  AvailableSku = _reflection.GeneratedProtocolMessageType('AvailableSku', (_message.Message,), dict(
    ...
    __module__ = 'pogoprotos.networking.responses.platform.responses.get_available_skus_and_balances_response_pb2'
