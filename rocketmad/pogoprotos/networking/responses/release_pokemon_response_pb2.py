...
_RELEASEPOKEMONRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='xl_candy_awarded', full_name='pogoprotos.networking.responses.ReleasePokemonResponse.xl_candy_awarded', index=2,
