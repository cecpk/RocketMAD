...
_GETRAIDDETAILSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='display_high_user_warning', full_name='pogoprotos.networking.responses.GetRaidDetailsResponse.display_high_user_warning', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_friend_invites_remaining', full_name='pogoprotos.networking.responses.GetRaidDetailsResponse.num_friend_invites_remaining', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='remote_ticket_used', full_name='pogoprotos.networking.responses.GetRaidDetailsResponse.remote_ticket_used', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_within_plfe_range', full_name='pogoprotos.networking.responses.GetRaidDetailsResponse.is_within_plfe_range', index=15,
