...
# source: pogoprotos/networking/responses/game/gamepoi/responses/get_grapeshot_upload_url_response.proto
...
_GETGRAPESHOTUPLOADURLRESPONSE_STATUS = _descriptor.EnumDescriptor(
  name='Status',
  full_name='pogoprotos.networking.responses.game.gamepoi.responses.GetGrapeshotUploadUrlResponse.Status',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_GETGRAPESHOTUPLOADURLRESPONSE_FILECONTEXTTOGRAPESHOTDATAENTRY = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.game.gamepoi.responses.GetGrapeshotUploadUrlResponse.FileContextToGrapeshotDataEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='pogoprotos.networking.responses.game.gamepoi.responses.GetGrapeshotUploadUrlResponse.FileContextToGrapeshotDataEntry.key', index=0,
...
_GETGRAPESHOTUPLOADURLRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.game.gamepoi.responses.GetGrapeshotUploadUrlResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='pogoprotos.networking.responses.game.gamepoi.responses.GetGrapeshotUploadUrlResponse.status', index=0,
...
GetGrapeshotUploadUrlResponse = _reflection.GeneratedProtocolMessageType('GetGrapeshotUploadUrlResponse', (_message.Message,), dict(
  ...
  FileContextToGrapeshotDataEntry = _reflection.GeneratedProtocolMessageType('FileContextToGrapeshotDataEntry', (_message.Message,), dict(
    DESCRIPTOR = _GETGRAPESHOTUPLOADURLRESPONSE_FILECONTEXTTOGRAPESHOTDATAENTRY,
    __module__ = 'pogoprotos.networking.responses.game.gamepoi.responses.get_grapeshot_upload_url_response_pb2'
    # @@protoc_insertion_point(class_scope:pogoprotos.networking.responses.game.gamepoi.responses.GetGrapeshotUploadUrlResponse.FileContextToGrapeshotDataEntry)
    ))
  ,
