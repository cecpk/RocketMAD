...
# source: pogoprotos/networking/responses/game/gamepoi/responses/submit_poi_text_metadata_update_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/responses/game/gamepoi/responses/submit_poi_text_metadata_update_response.proto',
  package='pogoprotos.networking.responses.game.gamepoi.responses',
  syntax='proto3',
  serialized_pb=_b('\nepogoprotos/networking/responses/game/gamepoi/responses/submit_poi_text_metadata_update_response.proto\x12\x36pogoprotos.networking.responses.game.gamepoi.responses\"\xaf\x02\n#SubmitPoiTextMetadataUpdateResponse\x12r\n\x06status\x18\x01 \x01(\x0e\x32\x62.pogoprotos.networking.responses.game.gamepoi.responses.SubmitPoiTextMetadataUpdateResponse.Status\"\x93\x01\n\x06Status\x12\x16\n\x12STATUS_UNSPECIFIED\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x12\n\x0eINTERNAL_ERROR\x10\x02\x12\x1f\n\x1bTOO_MANY_RECENT_SUBMISSIONS\x10\x03\x12\t\n\x05MINOR\x10\x04\x12\x11\n\rNOT_AVAILABLE\x10\x05\x12\x11\n\rINVALID_INPUT\x10\x06\x62\x06proto3')
)
...
_SUBMITPOITEXTMETADATAUPDATERESPONSE_STATUS = _descriptor.EnumDescriptor(
  name='Status',
  full_name='pogoprotos.networking.responses.game.gamepoi.responses.SubmitPoiTextMetadataUpdateResponse.Status',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_SUBMITPOITEXTMETADATAUPDATERESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.game.gamepoi.responses.SubmitPoiTextMetadataUpdateResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='pogoprotos.networking.responses.game.gamepoi.responses.SubmitPoiTextMetadataUpdateResponse.status', index=0,
...
SubmitPoiTextMetadataUpdateResponse = _reflection.GeneratedProtocolMessageType('SubmitPoiTextMetadataUpdateResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.responses.game.gamepoi.responses.submit_poi_text_metadata_update_response_pb2'
