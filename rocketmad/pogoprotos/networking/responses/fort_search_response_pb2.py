...
_FORTSEARCHRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sponsored_gift', full_name='pogoprotos.networking.responses.FortSearchResponse.sponsored_gift', index=15,
...
_FORTSEARCHRESPONSE.fields_by_name['sponsored_gift'].message_type = pogoprotos_dot_data_dot_vasa_dot_ad__details__pb2._ADDETAILS
