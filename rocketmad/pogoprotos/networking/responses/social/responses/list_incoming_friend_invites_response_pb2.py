...
# source: pogoprotos/networking/responses/social/responses/list_incoming_friend_invites_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/responses/social/responses/list_incoming_friend_invites_response.proto',
  package='pogoprotos.networking.responses.social.responses',
  syntax='proto3',
  serialized_pb=_b('\n\\pogoprotos/networking/responses/social/responses/list_incoming_friend_invites_response.proto\x12\x30pogoprotos.networking.responses.social.responses\x1a<pogoprotos/data/friends/incoming_friend_invite_display.proto\"\x8b\x02\n!ListIncomingFriendInvitesResponse\x12j\n\x06result\x18\x01 \x01(\x0e\x32Z.pogoprotos.networking.responses.social.responses.ListIncomingFriendInvitesResponse.Result\x12\x45\n\x07invites\x18\x02 \x03(\x0b\x32\x34.pogoprotos.data.friends.IncomingFriendInviteDisplay\"3\n\x06Result\x12\t\n\x05UNSET\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x11\n\rERROR_UNKNOWN\x10\x02\x62\x06proto3')
  ,
...
_LISTINCOMINGFRIENDINVITESRESPONSE_RESULT = _descriptor.EnumDescriptor(
  name='Result',
  full_name='pogoprotos.networking.responses.social.responses.ListIncomingFriendInvitesResponse.Result',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_LISTINCOMINGFRIENDINVITESRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.social.responses.ListIncomingFriendInvitesResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='pogoprotos.networking.responses.social.responses.ListIncomingFriendInvitesResponse.result', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='invites', full_name='pogoprotos.networking.responses.social.responses.ListIncomingFriendInvitesResponse.invites', index=1,
...
ListIncomingFriendInvitesResponse = _reflection.GeneratedProtocolMessageType('ListIncomingFriendInvitesResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.responses.social.responses.list_incoming_friend_invites_response_pb2'
