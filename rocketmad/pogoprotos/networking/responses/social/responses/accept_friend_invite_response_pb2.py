...
# source: pogoprotos/networking/responses/social/responses/accept_friend_invite_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/responses/social/responses/accept_friend_invite_response.proto',
  package='pogoprotos.networking.responses.social.responses',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nTpogoprotos/networking/responses/social/responses/accept_friend_invite_response.proto\x12\x30pogoprotos.networking.responses.social.responses\x1a+pogoprotos/data/player/player_summary.proto\"\xa7\x03\n\x1a\x41\x63\x63\x65ptFriendInviteResponse\x12\x63\n\x06result\x18\x01 \x01(\x0e\x32S.pogoprotos.networking.responses.social.responses.AcceptFriendInviteResponse.Result\x12\x35\n\x06\x66riend\x18\x02 \x01(\x0b\x32%.pogoprotos.data.player.PlayerSummary\"\xec\x01\n\x06Result\x12\t\n\x05UNSET\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x11\n\rERROR_UNKNOWN\x10\x02\x12\x1f\n\x1b\x45RROR_INVITE_DOES_NOT_EXIST\x10\x03\x12+\n\'ERROR_MAX_FRIENDS_LIMIT_REACHED_DELETED\x10\x04\x12#\n\x1f\x45RROR_INVITE_HAS_BEEN_CANCELLED\x10\x05\x12 \n\x1c\x45RROR_SENDER_HAS_MAX_FRIENDS\x10\x06\x12\"\n\x1e\x45RROR_RECEIVER_HAS_MAX_FRIENDS\x10\x07\x62\x06proto3')
  ,
...
_ACCEPTFRIENDINVITERESPONSE_RESULT = _descriptor.EnumDescriptor(
  name='Result',
  full_name='pogoprotos.networking.responses.social.responses.AcceptFriendInviteResponse.Result',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_ACCEPTFRIENDINVITERESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.social.responses.AcceptFriendInviteResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='pogoprotos.networking.responses.social.responses.AcceptFriendInviteResponse.result', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='friend', full_name='pogoprotos.networking.responses.social.responses.AcceptFriendInviteResponse.friend', index=1,
...
AcceptFriendInviteResponse = _reflection.GeneratedProtocolMessageType('AcceptFriendInviteResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.responses.social.responses.accept_friend_invite_response_pb2'
