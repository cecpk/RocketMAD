...
_VSSEEKERSTARTMATCHMAKINGRESPONSE_RESULT = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ERROR_QUEUE_TOO_FULL', index=12, number=12,
      serialized_options=None,
      type=None),
  ],
