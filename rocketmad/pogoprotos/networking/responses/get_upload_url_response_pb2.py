...
_GETUPLOADURLRESPONSE_CONTEXTSIGNEDURLSENTRY = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.GetUploadUrlResponse.ContextSignedUrlsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='pogoprotos.networking.responses.GetUploadUrlResponse.ContextSignedUrlsEntry.key', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='pogoprotos.networking.responses.GetUploadUrlResponse.ContextSignedUrlsEntry.value', index=1,
...
_GETUPLOADURLRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='context_signed_urls', full_name='pogoprotos.networking.responses.GetUploadUrlResponse.context_signed_urls', index=3,
...
GetUploadUrlResponse = _reflection.GeneratedProtocolMessageType('GetUploadUrlResponse', (_message.Message,), dict(
  ...
  ContextSignedUrlsEntry = _reflection.GeneratedProtocolMessageType('ContextSignedUrlsEntry', (_message.Message,), dict(
    ...
    # @@protoc_insertion_point(class_scope:pogoprotos.networking.responses.GetUploadUrlResponse.ContextSignedUrlsEntry)
    ))
  ,
