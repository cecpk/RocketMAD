...
class Pogom(Flask):
    ...
    def fullmap(self):
        ...
        return render_template(
            ...
            settings=settings,
            donate_text=i8ln('Donate'),
            statistics_text=i8ln('Statistics'),
            live_stats_text=i8ln('Live stats'),
            pokemon_text=i8ln('Pokémon'),
            filter_pokemon_text=i8ln('Filter Pokémon'),
            icon_size_text=i8ln('Icon size'),
            x_small_text=i8ln('X-Small'),
            small_text=i8ln('Small'),
            normal_text=i8ln('Normal'),
            large_text=i8ln('Large'),
            x_large_text=i8ln('X-Large'),
            pokemon_values_text=i8ln('Pokémon values'),
            filter_by_values_text=i8ln('Filter by values'),
            zero_iv_pokemon_text=i8ln('0% IV Pokémon'),
            hundo_iv_pokemon_text=i8ln('100% IV Pokémon'),
            rarity_text=i8ln('Rarity'),
            common_text=i8ln('Common'),
            uncommon_text=i8ln('Uncommon'),
            rare_text=i8ln('Rare'),
            very_rare_text=i8ln('Very Rare'),
            ultra_rare_text=i8ln('Ultra Rare'),
            new_spawn_text=i8ln('New Spawn'),
            scale_by_rarity_text=i8ln('Scale by rarity'),
            gyms_and_raids_text=i8ln('Gyms & Raids'),
            gyms_text=i8ln('Gyms'),
            raids_text=i8ln('Raids'),
            name_includes_text=i8ln('Name includes'),
            input_placeholder_filter_text=i8ln('Filter...'),
            gym_sidebar_text=i8ln('Gym sidebar'),
            teams_text=i8ln('Teams'),
            uncontested_text=i8ln('Uncontested'),
            mystic_text=i8ln('Mystic'),
            valor_text=i8ln('Valor'),
            instinct_text=i8ln('Instinct'),
            open_spot_only_text=i8ln('Open spot only'),
            ex_gyms_only_text=i8ln('EX eligible Gyms only'),
            gyms_in_battle_only_text=i8ln('Gyms in battle only'),
            last_scanned_text=i8ln('Last scanned'),
            any_time_text=i8ln('Any time'),
            within_hour_text=i8ln('Within last hour'),
            within_six_hours_text=i8ln('Within last 6 hours'),
            within_twelve_hours_text=i8ln('Within last 12 hours'),
            within_day_text=i8ln('Within last day'),
            within_week_text=i8ln('Within last week'),
            within_month_text=i8ln('Within last month'),
            within_six_months_text=i8ln('Within last 6 months'),
            within_year_text=i8ln('Within last year'),
            filter_raid_bosses_text=i8ln('Filter Raid Bosses'),
            active_raids_only_text=i8ln('Active Raids only'),
            ex_raids_only_text=i8ln('EX eligible Raids only'),
            raid_levels_text=i8ln('Raid levels'),
            level_1_text=i8ln('Level 1'),
            level_2_text=i8ln('Level 2'),
            level_3_text=i8ln('Level 3'),
            level_4_text=i8ln('Level 4'),
            level_5_text=i8ln('Level 5'),
            pokestops_text=i8ln('PokéStops'),
            pokestops_without_event_text=i8ln('PokéStops without event'),
            quests_text=i8ln('Quests'),
            filter_quests_text=i8ln('Filter Quests'),
            rocket_invasions_text=i8ln('Rocket Invasions'),
            filter_rocket_invasions_text=i8ln('Filter Rocket Invasions'),
            lures_text=i8ln('Lures'),
            normal_lures_text=i8ln('Normal Lures'),
            glacial_lures_text=i8ln('Glacial Lures'),
            magnetic_lures_text=i8ln('Magnetic Lures'),
            mossy_lures_text=i8ln('Mossy Lures'),
            weather_text=i8ln('Weather'),
            weather_cells_text=i8ln('Weather cells'),
            main_weather_header_text=i8ln('Main weather in header'),
            s2_cells_text=i8ln('S2 cells'),
            ex_cells_text=i8ln('Ex trigger cells'),
            gym_cells_text=i8ln('Gym cells'),
            pokestop_cells_text=i8ln('PokéStop cells'),
            warning_hidden_cells_text=i8ln('Warn about hidden cells'),
            map_misc_text=i8ln('Map misc'),
            spawnpoints_text=i8ln('Spawn points'),
            scanned_locations_text=i8ln('Scanned locations'),
            nest_parks_text=i8ln('Nest parks'),
            ex_parks_text=i8ln('EX eligible parks'),
            interaction_ranges_text=i8ln('Interaction ranges'),
            filter_interaction_ranges_text=i8ln('Filter interaction ranges'),
            pokemon_ranges_text=i8ln('Pokémon ranges'),
            gym_ranges_text=i8ln('Gym ranges'),
            pokestop_ranges_text=i8ln('PokéStop ranges'),
            spawnpoint_ranges_text=i8ln('Spawn point ranges'),
            location_text=i8ln('Location'),
            start_map_my_position_text=i8ln('Start map at my position'),
            start_map_last_position_text=i8ln('Start map at last position'),
            lock_start_marker=i8ln('Lock start location marker'),
            follow_me_text=i8ln('Follow me'),
            notifications_text=i8ln('Notifications'),
            pokemon_notifs_text=i8ln('Pokémon notifs'),
            notifs_filtered_by_id_text=i8ln('Notifs filtered by ID'),
            notifs_filtered_by_values_text=i8ln('Notifs filtered by values'),
            zero_iv_pokemon_notifs_text=i8ln('0% IV Pokémon notifs'),
            hundo_iv_pokemon_notifs_text=i8ln('100% IV Pokémon notifs'),
            rarity_notifs_text=i8ln('Rarity notifs'),
            tiny_rattata_notifs_text=i8ln('Tiny Rattata notifs'),
            big_magikarp_notifs_text=i8ln('Big Magikarp notifs'),
            notif_pokemon_only_text=i8ln('Show notif Pokémon only'),
            always_show_notif_pokemon=i8ln('Always show notif Pokémon'),
            use_pokemon_cries_text=i8ln('Use Pokémon cries'),
            raid_notifs_text=i8ln('Raid notifs'),
            raid_boss_notifs_text=i8ln('Raid Boss notifs'),
            egg_notifs_text=i8ln('Egg notifs'),
            pokestop_notifs_text=i8ln('PokéStop notifs'),
            quest_notifs_text=i8ln('Quest notifs'),
            rocket_invasion_notifs_text=i8ln('Rocket Invasion notifs'),
            lure_notifs_text=i8ln('Lure notifs'),
            browser_popups_text=i8ln('Browser popups'),
            play_sound_on_notif_text=i8ln('Play sound on notif'),
            upscale_notif_markers_text=i8ln('Upscale notif markers'),
            bounce_notif_markers=i8ln('Bounce notif markers')
        )
